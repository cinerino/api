...
const run_10 = require("./continuous/onExpiredMoneyTransfer/run");
const run_11 = require("./continuous/onExpiredPlaceOrder/run");
const run_12 = require("./continuous/onExpiredReturnOrder/run");
const run_13 = require("./continuous/cancelAccount/run");
const run_14 = require("./continuous/cancelCreditCard/run");
const run_15 = require("./continuous/cancelPointAward/run");
const run_16 = require("./continuous/cancelReservation/run");
const run_17 = require("./continuous/cancelSeatReservation/run");
const run_18 = require("./continuous/confirmReservation/run");
const run_19 = require("./continuous/deleteMember/run");
const run_20 = require("./continuous/givePointAward/run");
const run_21 = require("./continuous/importScreeningEvents/run");
const run_22 = require("./continuous/moneyTransfer/run");
const run_23 = require("./continuous/orderProgramMembership/run");
const run_24 = require("./continuous/payAccount/run");
const run_25 = require("./continuous/payCreditCard/run");
const run_26 = require("./continuous/payMovieTicket/run");
const run_27 = require("./continuous/placeOrder/run");
const run_28 = require("./continuous/refundAccount/run");
const run_29 = require("./continuous/refundCreditCard/run");
const run_30 = require("./continuous/refundMovieTicket/run");
const run_31 = require("./continuous/registerProgramMembership/run");
...
const run_38 = require("./continuous/updateEventAttendeeCapacity/run");
const run_39 = require("./continuous/voidMoneyTransfer/run");
const run_40 = require("./triggered/createImportScreeningEventsTask/run");
const run_41 = require("./triggered/createUpdateEventAttendeeCapacityTask/run");
...
exports.default = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(importEventsProjects.map((projectId) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield run_41.default({ project: { typeOf: 'Project', id: projectId } });
    })));
});
