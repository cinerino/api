...
const run_10 = require("./continuous/cancelReservation/run");
const run_11 = require("./continuous/cancelSeatReservation/run");
const run_12 = require("./continuous/confirmReservation/run");
const run_13 = require("./continuous/createOrderReport/run");
const run_14 = require("./continuous/deleteMember/run");
const run_15 = require("./continuous/givePointAward/run");
const run_16 = require("./continuous/moneyTransfer/run");
const run_17 = require("./continuous/orderProgramMembership/run");
...
const run_32 = require("./continuous/voidMoneyTransfer/run");
