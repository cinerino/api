...
const run_7 = require("./continuous/onConfirmedPlaceOrder/run");
const run_8 = require("./continuous/onConfirmedReturnOrder/run");
const run_9 = require("./continuous/onExpiredPlaceOrder/run");
const run_10 = require("./continuous/onExpiredReturnOrder/run");
const run_11 = require("./continuous/cancelAccount/run");
const run_12 = require("./continuous/cancelCreditCard/run");
const run_13 = require("./continuous/cancelPointAward/run");
const run_14 = require("./continuous/cancelSeatReservation/run");
const run_15 = require("./continuous/confirmReservation/run");
const run_16 = require("./continuous/givePointAward/run");
const run_17 = require("./continuous/importScreeningEvents/run");
const run_18 = require("./continuous/payAccount/run");
const run_19 = require("./continuous/payCreditCard/run");
const run_20 = require("./continuous/payMovieTicket/run");
const run_21 = require("./continuous/placeOrder/run");
const run_22 = require("./continuous/refundAccount/run");
const run_23 = require("./continuous/refundCreditCard/run");
const run_24 = require("./continuous/refundMovieTicket/run");
const run_25 = require("./continuous/registerProgramMembership/run");
