 ...
 * IDでイベント検索
 */
screeningEventRouter.get('/:id', permitScopes_1.default(['customer', 'events', 'events.read-only']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const attendeeCapacityRepo = new cinerino.repository.event.AttendeeCapacityRepo(redis.getClient());
        const eventRepo = new cinerino.repository.Event(mongoose.connection);
        const projectRepo = new cinerino.repository.Project(mongoose.connection);
 ...
 * イベントに対するオファー検索
 */
screeningEventRouter.get('/:id/offers', permitScopes_1.default(['customer', 'events', 'events.read-only']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const eventRepo = new cinerino.repository.Event(mongoose.connection);
        const projectRepo = new cinerino.repository.Project(mongoose.connection);
