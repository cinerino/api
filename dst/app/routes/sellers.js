 ...
 * 販売者作成
 */
sellersRouter.post('', permitScopes_1.default(['sellers.*', 'sellers']), rateLimit_1.default, ...[
 ...
 * 販売者検索
 */
sellersRouter.get('', permitScopes_1.default([iam_1.Permission.User, 'customer', 'sellers.*', 'sellers.read', 'sellers', 'sellers.read-only', 'pos']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 * IDで販売者検索
 */
sellersRouter.get('/:id', permitScopes_1.default([iam_1.Permission.User, 'customer', 'sellers.*', 'sellers.read', 'sellers', 'sellers.read-only']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const sellerRepo = new cinerino.repository.Seller(mongoose.connection);
...
sellersRouter.put('/:id', permitScopes_1.default(['sellers.*', 'sellers']), rateLimit_1.default, ...[
    express_validator_1.body('typeOf')
        .not()
        .isEmpty()
        .withMessage((_, __) => 'required'),
 ...
 * 販売者削除
 */
sellersRouter.delete('/:id', permitScopes_1.default(['sellers.*', 'sellers']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const sellerRepo = new cinerino.repository.Seller(mongoose.connection);
