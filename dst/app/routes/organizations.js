 ...
 */
organizationsRouter.get('/movieTheater', permitScopes_1.default(['sellers.read']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
