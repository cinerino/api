 ...
 * 会員プログラム検索
 */
programMembershipsRouter.get('', permitScopes_1.default([iam_1.Permission.User, 'customer', 'programMemberships.*', 'programMemberships', 'programMemberships.read-only']), rateLimit_1.default, validator_1.default, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
