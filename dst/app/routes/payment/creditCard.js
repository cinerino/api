...
creditCardPaymentRouter.post('/authorize', permitScopes_1.default(['transactions']), rateLimit_1.default, ...[
    ...
    express_validator_1.body('object.additionalProperty.*.value')
        ...
        .isString()
        .isLength({ max: ADDITIONAL_PROPERTY_VALUE_MAX_LENGTH }),
    express_validator_1.body('object.paymentMethodId')
        .optional()
        .isString()
    ...
    try {
        ...
        const action = yield cinerino.service.payment.chevre.authorize({
            ...
            object: Object.assign(Object.assign(Object.assign({ typeOf: cinerino.factory.action.authorize.paymentMethod.any.ResultType.Payment, paymentMethod: cinerino.factory.paymentMethodType.CreditCard, additionalProperty: (Array.isArray(req.body.object.additionalProperty))
                    ? req.body.object.additionalProperty.map((p) => {
                        return { name: String(p.name), value: String(p.value) };
                    })
                    : [], amount: req.body.object.amount, method: req.body.object.method, creditCard: creditCard }, (typeof req.body.object.name === 'string') ? { name: req.body.object.name } : undefined), (typeof req.body.object.paymentMethodId === 'string')
                ? { paymentMethodId: req.body.object.paymentMethodId }
                : undefined), (typeof req.body.object.orderId === 'string') ? { orderId: req.body.object.orderId } : undefined),
 ...
 */
// tslint:disable-next-line:use-default-type-parameter
creditCardPaymentRouter.post('/pubilshPaymentUrl', permitScopes_1.default(['transactions']), rateLimit_1.default, ...[
    express_validator_1.body('object')
        .not()
        .isEmpty(),
    express_validator_1.body('object.typeOf')
    ...
    try {
        ...
        const creditCard = Object.assign(Object.assign({}, req.body.object.creditCard), { memberId: memberId });
        const result = yield cinerino.service.payment.chevre.publishPaymentUrl({
            project: req.project,
            agent: { id: req.user.sub },
            object: {
